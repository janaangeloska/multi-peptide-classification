...
def plot_training_history(history, dataset_name):
    ...
    plt.tight_layout()
    save_path = os.path.join(RESULTS_DIR, f'esm2_multilabel_{dataset_name.lower()}_training.png')
...
if __name__ == "__main__":
    ...
    dbamp_model_path = os.path.join(RESULTS_DIR, 'esm2_multilabel_dbamp_final.pth')
    ...
    dramp_model_path = os.path.join(RESULTS_DIR, 'esm2_multilabel_dramp_final.pth')
    ...
    results_path = os.path.join(RESULTS_DIR, 'results_esm2_multilabel.csv')
    ...
    plt.tight_layout()
    comparison_path = os.path.join(RESULTS_DIR, 'esm2_multilabel_comparison.png')
